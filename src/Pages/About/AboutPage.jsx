    ...
    <section className="section2">
      <div className="container">
        <div className="aboutAll">
          ...
          <p>
            <a href="">Bai-Nur</a> - это интернет-магазин спортивной одежды и обуви. Мы продаем только оригинальные вещи, обувь и<br />   аксессуары от     ведущих спортивных брендов - Nike, Adidas, Puma, Reebok, VANS и др. На данный момент мы возим <br/> товары только на заказ. Мы доставляем     вещи из Турции, США, России. <br />
